...
config :ueberauth,
       Ueberauth,
       providers: [
         keycloak: {Ueberauth.Strategy.Keycloak, [default_scope: "openid email name"]}
       ]

keycloak_url = System.get_env("MOBILIZON_AUTH_OBLONG_HOST", nil)

# Realm may be something else than master
config :ueberauth, Ueberauth.Strategy.Keycloak.OAuth,
  client_id: System.get_env("MOBILIZON_AUTH_OBLONG_CLIENT_ID", nil),
  client_secret: System.get_env("MOBILIZON_AUTH_OBLONG_CLIENT_SECRET", nil),
  site: keycloak_url,
  authorize_url: "#{keycloak_url}/oauth/authorize",
  token_url: "#{keycloak_url}/oauth/token",
  userinfo_url: "#{keycloak_url}/oauth/userinfo",
  token_method: :post
